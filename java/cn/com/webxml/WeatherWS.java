 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/F:/Webservice/WeatherWS.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/F:/Webservice/WeatherWS.xml");
